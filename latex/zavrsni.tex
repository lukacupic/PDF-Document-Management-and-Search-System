...
\begin{figure}
\makebox[\textwidth]{\includegraphics[width=\textwidth]{diagram.png}}
...
Ovom problemu moglo bi se doskočiti normaliziranjem mjere sličnosti na način da se mjera sličnosti između dokumenata $d_1$ i $d_2$ umjesto na klasičan način — \text{similarity}($d_1, d_2$) — računa tako da se dobiveni rezultat podijeli mjerom sličnosti dokumenta $d_1$ (ili $d_2$) sa samim sobom. Ovakav način računanja mjere sličnosti prikazan je izrazom \ref{eq:docsim}.
\begin{equation}
